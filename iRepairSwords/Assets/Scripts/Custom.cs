...
public class Quest
{
    ...
    private static float repairPriceBase = 50.0f;
    private static float replacePriceBase = 100.0f;
    private static float repairTimeBase = 5.0f;
    private static float sellTimeBase = 10.0f;
